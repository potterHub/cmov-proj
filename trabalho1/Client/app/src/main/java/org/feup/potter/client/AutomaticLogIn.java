...
public class AutomaticLogIn extends Activity implements HttpResponsePassword {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.data.user = Util.loadUser(this.data.userPath, this);

        this.data.orderItemIdList = new ArrayList<String>();
                              ...
                              try {
                                  ...
                                  if (tokenArr.length >= 2) {
                                      ...
                                      if (AutomaticLogIn.this.data.user == null) {
                                          ...
                                          Util.saveUser(AutomaticLogIn.this.data.user, AutomaticLogIn.this.data.userPath, getApplicationContext());
